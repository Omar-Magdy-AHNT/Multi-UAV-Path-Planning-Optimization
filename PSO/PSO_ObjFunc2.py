...
def func2(l,d):  # noqa: E741
    dang = []
    for i in range(numdrones):  # noqa: F405
        totaldanger = 0
        # Start and end index for the current drone's track points
        start_idx = i * (numtrackp + 2)  # Start index for current drone  # noqa: F405
        end_idx = start_idx + numtrackp  # End index for current drone (last track point)  # noqa: F405
        ...
        for j in range(start_idx, end_idx):  
            ...
            for k in range(len(obstlist)):  # noqa: F405
                x1 = obstlist[k][0]  # noqa: F405
                y1 = obstlist[k][1]  # noqa: F405
                z1 = obstlist[k][2]
